 ...
 * @author Maureen
 */
public class filtercbo extends HttpServlet {
     ...
     */
    String DistrictID,current_districts1;
   HttpSession session; 
...
protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DistrictID=request.getParameter("district"); 
           ...
           String districts="select * from CBO where DistrictID='"+DistrictID+"'";
           ...
           current_districts1="<option value=\"\">Choose CBO</option>";
           
           while(conn.rs.next()){
               
         //dist arraylist stays in the session
//          dist.add(conn.rs.getString("DistrictName")); 
           System.out.println("DIST ID"+conn.rs.getInt("CBOID"));
          
          //dynamically add districts to the string array
          
          current_districts1=current_districts1+"<option value=\""+conn.rs.getInt("CBOID")+"\">"+conn.rs.getString("CBO")+"</option>";
