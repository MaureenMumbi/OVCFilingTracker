...
protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        CountyID=request.getParameter("district"); 
           ...
           String districts="select * from District where Countyid='"+CountyID+"'";
           ...
           current_districts1="<option selected value=\"\">Choose District</option>";
...
//          dist.add(conn.rs.getString("DistrictName")); 
          ...
          current_districts1=current_districts1+"<option value=\""+conn.rs.getInt("DistrictID")+"\">"+conn.rs.getString("District")+"</option>";
