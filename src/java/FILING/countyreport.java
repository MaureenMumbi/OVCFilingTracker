...
//         System.out.println("mergecounter b4"+mergecounter);
   ...
   for(int j=0;j<County.length;j++){
               String getDistrictCounts ="select * from District where Countyid='"+County[j]+"' order by District";
...
//   cell3=rw5.createCell(2);
          ...
          String getData="select "
                  ...
                  + "WHERE Clientdetails.District ='"+conn.rs2.getString("DistrictID")+"' and Clientdetails.OVCID = ovcfiling.ovcid and Clientdetails.Exited='1' and (Year='"+Year+"' OR Year='') "
...
//                             cell6=rw5.createCell(doccounter);
                        ...
                        if( doc.equals("8") ) {
                         percent=value1/activehh*100;
                           ...
                           System.out.println("percenta "+percent+" "+value1+"  "+activeOVC+" act "+activeovc);
...
response.setHeader("Content-Disposition", "attachment; filename=County_Filing_Tracker_Report_"+Year+".xls");
