<%-- 
    Document   : cbodetails
    Created on : Apr 1, 2015, 3:00:36 PM
    Author     : user
--%>
...
<!--			    <div class="actions-wrapper">
		    	...
		    	<!-- Basic inputs -->
	            <h5 class="widget-name"><i class="icon-align-justify"></i>DETAILS REPORT</h5>
  <%
                ...
                session.removeAttribute("replytext");
                        ...
                        %>
	            <form class="form-horizontal" method="post" id="validate" action="childdetailsreport">
					<fieldset>
            ...
            String getcounty="select * from county";
                        ...
                        while(conn.rs.next()){
						       ...
						       <div class="control-group">
	                                        ...
	                                        <div class="controls">
	                                             <select  id="District"  class=" validate[required] select "   name="District"  data-placeholder="Choose a District..."  tabindex="2">
