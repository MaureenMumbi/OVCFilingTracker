<%-- 
    Document   : countyreport
    Created on : Mar 31, 2015, 10:40:40 AM
    Author     : user
--%>
...
<link href='css/fonts.css' rel='stylesheet' type='tex                       t/css'>
...
<!--			    <div class="actions-wrapper">
		    	...
		    	<!-- Basic inputs -->
	            <h5 class="widget-name"><i class="icon-align-justify"></i>COUNTY REPORT</h5>
  <%
                ...
                session.removeAttribute("replytext");
                        ...
                        %>
	            <form class="form-horizontal" method="post" id="validate" action="countyreport">
					<fieldset>
...
<!--						    	<div class="alert margin">
						       ...
						       <div class="control-group">
	                                        ...
	                                        <div class="controls">
	                                            <select multiple data-placeholder="Choose a County..." class="select" name="County" tabindex="2">
	                                                <option value=""></option> 
                                                        <% 
