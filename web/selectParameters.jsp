<%-- 
    ...
    Created on : Mar 11, 2015, 4:45:50 PM
    Author     : user
--%>
...
<%-- 
    Document   : newentries
    Created on : Feb 19, 2015, 4:32:57 PM
    Author     : Maureen
--%>
...
{
//    
//$("#s2id_District").html("<a class='select2-choice' tabindex='-1' onclick='return false;' href='javascript:void(0)'><span>Choose District</span><abbr class='select2-search-choice-close' style='display:none;'></abbr><div><b></b></div>");



//document.getElementById("s2id_District").innerHTML="<a href='javascript:void(0)' onclick='return true;' class='select2-choice' tabindex='-1'>   <span>zzz </span><abbr class='select2-search-choice-close' style='display:none;'></abbr>   <div><b></b></div></a><input class='select2-focusser select2-offscreen' type='text'>";

//$("#s2id_District").html("<a href='javascript:void(0)' onclick='return false;' class='select2-choice' tabindex='-1'>   <span>zzz </span><abbr class='select2-search-choice-close' style='display:none;'></abbr>   <div><b></b></div></a><input class='select2-focusser select2-offscreen' type='text'>");
//$("#s2id_District").html("<a href='javascript:void(0)' disabled='false' onclick='return false;' class='select2-choice' tabindex='-1'><span>Choose District Namevvvvv</span><abbr class='select2-search-choice-close' style='display:none;'></abbr>   <div><b></b></div></a><input class='select2-focusser select2-offscreen' type='text'><div class='select2-drop select2-with-searchbox' style='display:none'>   <div class='select2-search'>       <input tabindex='2' autocomplete='off' class='select2-input' type='text'>   </div>   <ul class='select2-results'>   </ul></div>");
//alert($(".select2-choice").html());
...
//         alert(distr);
//    var t=document.getElementById("county_"+index);
    var cboname =cbo.options[cbo.selectedIndex].value;   
...
if (xmlhttp.readyState==4 && xmlhttp.status==200)
{
document.getElementById("CHW").innerHTML=xmlhttp.responseText;
$("#Year").select2();
}
}

xmlhttp.open("POST","/OVCFilingTracker/filterCHW?cbo="+cboname,true);
...
<!--			    <div class="actions-wrapper">
  ...
  <%
                ...
                session.removeAttribute("replytext");
                        ...
                        %>
	            <form class="form-horizontal" method="post" id="validate" action="storeParam">
					<fieldset>
            ...
            String getcounty="select * from county";
                        ...
                        while(conn.rs.next()){
						       ...
						       <div class="control-group">
	                                        ...
	                                        <div class="controls">
	                                             <select  required id="District"  class=" select validate[required]  styled " onchange="filter_cbo(this);"   name="District"  data-placeholder="Choose a District..."  tabindex="2">
						       ...
						       <div class="control-group">
	                                        ...
	                                        <div class="controls">
	                                             <select   required onchange="filter_CHW(this);"  id="CBO"  name="CBO"  data-placeholder="Choose a CBO..." class="select" tabindex="2">
						       ...
						       <div class="control-group">
	                                        <label class="control-label">CHW</label>
	                                        <div class="controls">
	                                             <select id="CHW"  required name="CHW"  data-placeholder="Choose a CHW..." class="select" tabindex="2" >
						       ...
						       <div class="control-group">
	                                        ...
	                                        <div class="controls">
	                                             <select id="Year" required  name="Year"  data-placeholder="Choose Year..." class="select" tabindex="2" >
                                          ...
                                          <div class="form-actions">
	                                        <button class="btn btn-primary" type="submit">View OVC's</button>
